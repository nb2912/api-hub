...
export default function Register() {
  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center relative overflow-hidden bg-[#f8f9ff]">
      ...
      <div className="z-10 w-full max-w-[520px] px-6 py-12">
        {/* Brand Anchor */}
        <div className="flex flex-col items-center mb-10">
          ...
          <h1 className="font-headline font-[900] text-4xl tracking-tighter text-on-surface">Join ScholarHub</h1>
          <p className="text-on-surface-variant mt-3 font-bold tracking-[0.1em] uppercase text-[10px] opacity-60">Build your academic legacy</p>
        </div>
        ...
        <motion.div 
          ...
          className="bg-white rounded-[2.5rem] p-10 lg:p-12 shadow-[0_32px_64px_-16px_rgba(5,52,92,0.1)] border border-white/40 backdrop-blur-sm"
        >
          <header className="mb-10 text-center sm:text-left">
            <h2 className="font-headline text-2xl font-[900] tracking-tight text-on-surface">Create your account</h2>
            <p className="text-on-surface-variant text-sm mt-2 font-medium opacity-70">Register with your institutional email address.</p>
          </header>
          ...
          <div className="space-y-4">
            <button className="w-full flex items-center justify-center gap-3 py-4 bg-on-surface text-white rounded-2xl font-[900] text-xs uppercase tracking-widest hover:bg-on-surface/90 transition-all active:scale-[0.98] shadow-xl shadow-on-surface/10">
              <GithubIcon className="w-5 h-5" /> Sign up with GitHub
            </button>
          </div>

          <div className="relative flex py-8 items-center">
            <div className="flex-grow border-t border-black/5"></div>
            <span className="flex-shrink mx-4 text-outline/40 text-[10px] font-black tracking-[0.2em] uppercase">or direct register</span>
            <div className="flex-grow border-t border-black/5"></div>
          </div>
          ...
          <form onSubmit={handleRegister} className="space-y-6">
            ...
            <div className="space-y-2">
              <label className="text-[10px] font-black text-on-surface-variant uppercase tracking-[0.2em] ml-2 opacity-60">Password</label>
              <div className="relative">
            ...
            <button type="submit" className="w-full py-5 bg-primary text-white font-[900] text-sm uppercase tracking-widest rounded-2xl shadow-2xl shadow-primary/20 hover:scale-[1.02] active:scale-[0.98] transition-all mt-4">
              Create Account
            </button>
          </form>
        </motion.div>
